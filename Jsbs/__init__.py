...
__author__ = "سورس ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦 <https://github.com/jmthonen/jmub0>"
__copyright__ = f" حقوق سورس  (C) 2020 - 2022  {__author__}"

jmub.version = __version__
jmub.tgbot.version = __version__
LOGS = logging.getLogger("سورس ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦")
bot = jmub
tbot = tgbot
