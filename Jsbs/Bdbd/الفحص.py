...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**سورسꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦  يعمل بنجاح**"
...
def jmthonalive_text():
    EMOJI = gvarstatus("ALIVE_EMOJI") or "  ✥ "
    jmthon_caption = "**سورس ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦 يعمل بنجاح**\n"
...
ROZ_PIC = "https://graph.org/file/cc6c91f662920d54e85de.jpg"
RAZAN = Config.TG_BOT_USERNAME
ROZ_T = (
    f"**⌯︙بوت ꫀ𝑑𝑤𝑎𝑟𝑑 𝑘ꫀꪀ𝑤𝑎𝑦يعمل بنجاح 🤍،**\n"
    f"**   - اصدار التليثون :** `1.23.0\n`"
    f"**   - اصدار السورس :** `4.0.0`\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == jmub.uid:
            buttons = [
                [
                    Button.url("مبرمج السـورس ⚙️", "https://t.me/SC_60"),
                    Button.url("المطـور 👨🏼‍💻", "https://t.me/SC_60"),
                ]
            ]
